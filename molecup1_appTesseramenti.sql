...
--
-- Host: localhost:3306
-- Generation Time: Jan 17, 2023 at 03:44 PM
...
--
-- Database: `molecup1_appTesseramenti`
--
...
INSERT INTO `amministratori` (`id`, `mail`, `psw`, `id_squadra`, `id_stagione`, `super`) VALUES
(1, 'prova@mail.com', '$2y$10$EghkNgkk3rXXv4esyl4uDON0fGZXZiughETNaJiovmQ4drGws6ABq', 1, 1, 0),
(3, 'prova2@mail.com', '$2y$10$LG8kfHd2FEaNm2Vsi7B2uuYdYl9sEvqHd4bAGCo0VdgPeXbIwFfBq', 1, 1, 0),
(4, 'prova3@mail.com', 'psw', 1, 1, 0),
(5, 'marcomag416@gmail.com', '$2y$10$Ku9eq9XJSAfxgptOxRFB0urnzB2xLqEbAzwtgMM1cURUwKRqIqQhu', 1, 4, 1);

-- --------------------------------------------------------

--
-- Table structure for table `certificati_med`
--
...
--
-- Dumping data for table `certificati_med`
--
...
--
-- Table structure for table `codici_ripristino`
--
...
--
-- Dumping data for table `codici_ripristino`
--

INSERT INTO `codici_ripristino` (`id_amministratore`, `token`, `data_scadenza`) VALUES
(5, '$2y$10$sDhAB0HA0Vy99CYmPTF.Yujxlnw.f9.Lj3FvTA1jv7wDLsy3JV.d6', '2023-01-18 01:00:51'),
(5, '$2y$10$Y2PxCKtQEwfgaM4qsKJzpus3J8RIl5YRRVy4Wtk5rrs5AYjwMafkS', '2023-01-18 01:25:28');
...
--
-- Table structure for table `d_tesserati`
--
...
--
-- Dumping data for table `d_tesserati`
--
...
--
-- Table structure for table `elenchi_inviati`
--
...
--
-- Table structure for table `g_tesserati`
--
...
--
-- Dumping data for table `g_tesserati`
--
...
('$2y$10$R2Fa2dzMrZUHoUcgeK5Z3uidR/yvrQFrGGtR/WoarDD/0lpsgtmdq', 5, '2023-01-17 14:41:39'),
('$2y$10$tpjCAqPdcYiF6OawunJzseDwAtnaJh5HliTRMjZuMgtsmIFAlL8Pe', 5, '2023-01-17 14:43:20'),
...
--
-- Indexes for table `certificati_med`
--
ALTER TABLE `certificati_med`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `codici_ripristino`
--
ALTER TABLE `codici_ripristino`
  ADD UNIQUE KEY `token` (`token`);

--
-- Indexes for table `dirigenti`
--
...
--
-- AUTO_INCREMENT for table `amministratori`
--
ALTER TABLE `amministratori`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `certificati_med`
--
ALTER TABLE `certificati_med`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `dirigenti`
--
ALTER TABLE `dirigenti`
...
--
-- AUTO_INCREMENT for table `leghe`
--
ALTER TABLE `leghe`
...
--
-- AUTO_INCREMENT for table `stagioni`
--
ALTER TABLE `stagioni`
