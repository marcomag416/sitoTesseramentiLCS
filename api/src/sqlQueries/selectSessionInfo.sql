select amm.id, amm.mail, sq.nome as squadra, sq.id as idsquadra, stag.nome as stagione, stag.id as idstagione, leghe.nome as lega, leghe.id as idlega, amm.super as super  
